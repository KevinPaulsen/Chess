...
public class Directions {
    ...
    public static final Direction[] KNIGHTS =
            new Direction[]{UP_UP_RIGHT, UP_UP_LEFT, UP_LEFT_LEFT, DOWN_LEFT_LEFT, DOWN_DOWN_LEFT,
                    DOWN_DOWN_RIGHT, DOWN_RIGHT_RIGHT, UP_RIGHT_RIGHT};
