...
public class MoveGenerator {
    ...
    private static final MagicData[] ROOK_MAGICS = {
            ...
            new MagicData(0x48FFFE99FECFAA00L, 11),
            new MagicData(0x48FFFE99FECFAA00L, 10),
            new MagicData(0x497FFFADFF9C2E00L, 10),
            new MagicData(0x613FFFDDFFCE9200L, 10),
            new MagicData(0xffffffe9ffe7ce00L, 10),
            new MagicData(0xfffffff5fff3e600L, 10),
            new MagicData(0x0003ff95e5e6a4c0L, 10),
            new MagicData(0x510FFFF5F63C96A0L, 11),
            new MagicData(0xEBFFFFB9FF9FC526L, 12),
            new MagicData(0x61FFFEDDFEEDAEAEL, 11),
            new MagicData(0x53BFFFEDFFDEB1A2L, 11),
            new MagicData(0x127FFFB9FFDFB5F6L, 11),
            new MagicData(0x411FFFDDFFDBF4D6L, 11),
            new MagicData(0x1004400080a13L, 11),
            new MagicData(0x0003ffef27eebe74L, 11),
            new MagicData(0x7645FFFECBFEA79EL, 12),
    };
    private static final MagicData[] BISHOP_MAGICS = {
            new MagicData(0xffedf9fd7cfcffffL, 6),
            new MagicData(0xfc0962854a77f576L, 5),
            ...
            new MagicData(0xfc0a66c64a7ef576L, 5),
            new MagicData(0x7ffdfdfcbd79ffffL, 6),
            new MagicData(0xfc0846a64a34fff6L, 5),
            new MagicData(0xfc087a874a3cf7f6L, 5),
            ...
            new MagicData(0xfc0864ae59b4ff76L, 5),
            new MagicData(0x3c0860af4b35ff76L, 5),
            new MagicData(0x73C01AF56CF4CFFBL, 5),
            new MagicData(0x41A01CFAD64AAFFCL, 5),
            ...
            new MagicData(0x7c0c028f5b34ff76L, 5),
            new MagicData(0xfc0a028e5ab4df76L, 5),
            ...
            new MagicData(0xDCEFD9B54BFCC09FL, 5),
            new MagicData(0xF95FFA765AFD602BL, 5),
            ...
            new MagicData(0x43ff9a5cf4ca0c01L, 5),
            new MagicData(0x4BFFCD8E7C587601L, 5),
            new MagicData(0xfc0ff2865334f576L, 5),
            new MagicData(0xfc0bf6ce5924f576L, 5),
            ...
            new MagicData(0xc3ffb7dc36ca8c89L, 5),
            new MagicData(0xc3ff8a54f4ca2c89L, 5),
            new MagicData(0xfffffcfcfd79edffL, 6),
            new MagicData(0xfc0863fccb147576L, 5),
            ...
            new MagicData(0xfc087e8e4bb2f736L, 5),
            new MagicData(0x43ff9e4ef4ca2c89L, 6),
    };
    ...
    public MoveList generateMoves() {
        ...
        if (friendlyPieceGroup.kingCoord != 0) {
            calculateAttackData();
            generateKingMoves();
        }
    ...
    private void calculateAttackData() {
        ...
        long friendlyKingMask = friendlyPieceGroup.kingCoord;
        ...
        opponentAttackMap |= KING_MOVE_MASKS[Long.numberOfTrailingZeros(
                attackingPieceGroup.kingCoord)];
    ...
    private void generateKingMoves() {
        ...
        long kingMoveMask = KING_MOVE_MASKS[Long.numberOfTrailingZeros(
                friendlyPieceGroup.kingCoord)] & ~(board.getOccupancyMap(friendlyPieceGroup.color) |
                opponentAttackMap);
        addMoves(friendlyPieceGroup.king, friendlyPieceGroup.kingCoord, kingMoveMask,
                 MoveList.Status.NORMAL);

        // Add castling moves
        kingMoveMask = 0x0L;
        long occupancy = (board.getOccupancyMap() ^ friendlyPieceGroup.kingCoord);
    ...
    private void calculateSlidingAttackMap() {
        long friendlyKingBit = friendlyPieceGroup.kingCoord;
    ...
    private void calculatePinRays() {
        int friendlyKingIndex = Long.numberOfTrailingZeros(friendlyPieceGroup.kingCoord);
        hvPinRayMap = getPinRays(board.getOccupancyMap(), ROOK_MOVE_MASKS[friendlyKingIndex],
                                 ...
                                 friendlyKingIndex, ROOK_TABLE, ROOK_MAGICS);
        d12PinRayMap = getPinRays(board.getOccupancyMap(), BISHOP_MOVE_MASKS[friendlyKingIndex],
                                  ...
                                  friendlyKingIndex, BISHOP_TABLE, BISHOP_MAGICS);
    }
    ...
    private void calculatePawnAttackData(long friendlyKingMask) {
        ...
        if ((pawnAttackSquares & friendlyKingMask) != 0) {
            inDoubleCheck = inCheck;
            inCheck = true;
            int kingFile = Long.numberOfTrailingZeros(friendlyPieceGroup.kingCoord) % 8;
            int kingRank = Long.numberOfTrailingZeros(friendlyPieceGroup.kingCoord) / 8;
            long attackingPieceBit =
                    ROW_MASKS[kingRank + ((friendlyPieceGroup.color == WHITE) ? 1 : -1)] &
                            ((kingFile > 0 ? FILE_MASKS[kingFile - 1] : 0) |
                                    (kingFile < 7 ? FILE_MASKS[kingFile + 1] : 0));
        ...
        if (game.hasEPTarget() && (epTarget = game.getEnPassantTarget().getBitMask()) != 0) {
            ...
            if (!((epRank & friendlyKingMask) == 0 || (epRank & rookAndQueen) == 0 ||
                    (epRank & pawns) == 0)) {
                long upperMask = SLIDING_ATTACK_MASKS[Long.numberOfTrailingZeros(
                        friendlyPieceGroup.kingCoord)][RIGHT.ordinal()];
                long lowerMask = SLIDING_ATTACK_MASKS[Long.numberOfTrailingZeros(
                        friendlyPieceGroup.kingCoord)][LEFT.ordinal()];
                if (eplPawn != 0) {
